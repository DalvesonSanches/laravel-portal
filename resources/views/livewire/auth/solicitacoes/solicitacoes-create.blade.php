            ...
            <x-step wire:model="step">
                ...
                <x-step.items step="5" title="Revisão" description="Confira seus dados">
                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-secondary-800">
                        <h3 class="mb-4 text-lg font-semibold text-gray-700 dark:text-gray-300">Resumo do Cadastro</h3>
                        ...
                        <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                            ...
                            <!-- Adicione os outros campos das etapas 3 e 4 aqui -->

                            @if($is_same_owner === 'nao' && isset($solicitanteForm))
                                <h3 class="mb-4 text-md font-semibold text-gray-700 dark:text-gray-300">Dados do Solicitante</h3>
                                ...
                                <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                    ...
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500">Natureza Juridica</dt>
