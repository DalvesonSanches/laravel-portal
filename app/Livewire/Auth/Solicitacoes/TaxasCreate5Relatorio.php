...
class TaxasCreate5Relatorio extends Component
{
    ...
    #[On('abrir-taxas-create5-relatorio')]
    public function abrirModalTaxa5Relatorio($solicitacaoId)
    {
        ...
        $this->dispatch('carregar-dados-taxas-create5-relatorio');
    }

    // Este atributo faz o componente "ouvir" o evento disparado pela função acima (parte2)
    #[On('carregar-dados-taxas-create5-relatorio')]
    public function carregarDadosCreate5Relatorio()//aqui carregar os dados da taxa antes de salvar
    {
    ...
    {
        return view('livewire.auth.solicitacoes.taxas-create5-relatorio');
    }
}
