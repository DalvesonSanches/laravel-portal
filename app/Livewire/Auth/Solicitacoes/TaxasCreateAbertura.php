...
class TaxasCreateAbertura extends Component
{
    ...
    #[On('abrir-taxas-create-abertura')]
    public function abrirModalTaxaAbertura($solicitacaoId)
    {
        ...
        $this->dispatch('carregar-dados-taxas-create-abertura');
    }

      // Este atributo faz o componente "ouvir" o evento disparado pela função acima (parte2)
    #[On('carregar-dados-taxas-create-abertura')]
    public function carregarDadosCreateAbertura()//aqui carregar os dados da taxa antes de salvar
    {
    ...
    {
        return view('livewire.auth.solicitacoes.taxas-create-abertura');
    }
}
